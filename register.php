...
if(isset($_POST['btn-signup']))
{
 ...
 if(mysql_query("INSERT INTO users(fullname,email,password) VALUES('$uname','$email','$upass')"))
 {
  ?>
        <script>alert('Account geregistreerd');</script>
        <?php
 }
 else
 {
  ?>
        <script>alert('Er is iets fout gelopen bij registratie');</script>
        <?php
 }
}
?>
...
<head>
    ...
    <title>CS50 Belgium - Register</title>
